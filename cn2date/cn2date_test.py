...
class Cn2DateTest(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.cn_data_dict = {
            ...
            # "前2年": (datetime(2019, 1, 1), datetime(2021, 12, 31, 23, 59, 59, 999999)),
            # "前2个年": (datetime(2019, 1, 1), datetime(2021, 12, 31, 23, 59, 59, 999999)),
            # "前2个年份": (datetime(2019, 1, 1), datetime(2021, 12, 31, 23, 59, 59, 999999)),
            # "前两年": (datetime(2019, 1, 1), datetime(2021, 12, 31, 23, 59, 59, 999999)),
            # "前两个年": (datetime(2019, 1, 1), datetime(2021, 12, 31, 23, 59, 59, 999999)),
            # "前两个年份": (datetime(2019, 1, 1), datetime(2021, 12, 31, 23, 59, 59, 999999)),
            # "后2年": (datetime(2022, 1, 1), datetime(2024, 12, 31, 23, 59, 59, 999999)),
            # "后2个年": (datetime(2022, 1, 1), datetime(2024, 12, 31, 23, 59, 59, 999999)),
            # "后2个年份": (datetime(2022, 1, 1), datetime(2024, 12, 31, 23, 59, 59, 999999)),
            # "后两年": (datetime(2022, 1, 1), datetime(2024, 12, 31, 23, 59, 59, 999999)),
            # "后两个年": (datetime(2022, 1, 1), datetime(2024, 12, 31, 23, 59, 59, 999999)),
            # "后两个年份": (datetime(2022, 1, 1), datetime(2024, 12, 31, 23, 59, 59, 999999)),
            # "2年前": (datetime(2019, 1, 1), datetime(2020, 12, 31, 23, 59, 59, 999999)),
            # "两年前": (datetime(2019, 1, 1), datetime(2020, 12, 31, 23, 59, 59, 999999)),
            # "2年后": (datetime(2023, 1, 1), datetime(2024, 12, 31, 23, 59, 59, 999999)),
            # "两年后": (datetime(2023, 1, 1), datetime(2024, 12, 31, 23, 59, 59, 999999)),
            ...
            # "前2月": (datetime(2021, 7, 1), datetime(2021, 7, 31, 23, 59, 59, 999999)),
            # "前2个月": (datetime(2021, 7, 1), datetime(2021, 7, 31, 23, 59, 59, 999999)),
            # "前2个月份": (datetime(2021, 7, 1), datetime(2021, 7, 31, 23, 59, 59, 999999)),
            # "前两月": (datetime(2021, 7, 1), datetime(2021, 7, 31, 23, 59, 59, 999999)),
            # "前两个月": (datetime(2021, 7, 1), datetime(2021, 7, 31, 23, 59, 59, 999999)),
            # "前两个月份": (datetime(2021, 7, 1), datetime(2021, 7, 31, 23, 59, 59, 999999)),
